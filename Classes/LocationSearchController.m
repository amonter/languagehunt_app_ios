...
- (void)viewDidLoad {
    ...
    titleText.lineBreakMode = UILineBreakModeWordWrap;
    titleText.textAlignment = NSTextAlignmentCenter;
    titleText.numberOfLines = 0;
    titleText.textColor = [UIColor whiteColor];
    titleText.font = [UIFont fontWithName:@"Delicious-Heavy" size:20.5];
    titleText.text = @"Where would you like to make or do that?";*/
    ...
    NSLog(@"Onject ******* 1 %@", self.selectedDataTable);
