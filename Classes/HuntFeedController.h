...
@interface HuntFeedController : FeedTableBase <UIAlertViewDelegate, UISearchBarDelegate, UIScrollViewDelegate, HuntProfileHelperDelegate> {
...
- (void) insertTheFeeler:(bool) theStatus;
- (void)resetTable;
