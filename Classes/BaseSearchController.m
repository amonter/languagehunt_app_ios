...
- (void)setCellSelected:(UITableViewCell *)cell {
    ...
    ((UILabel*)[cell.contentView viewWithTag:44555]).textColor = [UIColor whiteColor];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *cell = [self.theTable cellForRowAtIndexPath:indexPath];
    ...
    if ([selectedKeys containsObject:[feelerId objectAtIndex:0]]){
        ((UILabel*)[cell.contentView viewWithTag:44555]).textColor = [UIColor colorWithRed:102/255.0 green:102/255.0 blue:102/255.0 alpha:1.0];
        cell.contentView.backgroundColor = [UIColor clearColor];
        [[cell.contentView viewWithTag:992182] removeFromSuperview];
        [self.selectedDataDic removeObjectForKey:[NSString stringWithFormat:@"%i",[[feelerId objectAtIndex:0]intValue]]];
        [self.selectedData removeObject:theElement];
        //cell.selected = false;        
        //NSLog(@"REMOVING %@",theElement);
        return;
    }
    ...
    //NSLog(@"Selected DATA %@", theElement);
