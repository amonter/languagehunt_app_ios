...
@interface BaseControllerDummy : UIViewController <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, SelectedDataDelegate>
...
@property (nonatomic, retain) SelectedDataController *selectedDataTable;
@property (nonatomic, retain) NSMutableDictionary* selectedDataDic;
@property (nonatomic, retain) NSMutableArray* selectedData;
@property (nonatomic, retain) NSMutableArray* dataNew;
